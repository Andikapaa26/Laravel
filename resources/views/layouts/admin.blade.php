...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <header class="app-header"><a class="app-header__logo" href="index.html">SIDAP</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('img/pegawai.png')}}" width="50px" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Andika Pangetsu</p>
          <p class="app-sidebar__user-designation">Admin SIDAP</p>
        </div>
      </div>
      <ul class="app-menu">
